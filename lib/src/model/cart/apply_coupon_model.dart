class ApplyCouponModel {
  final int status;
  final ApplyCouponModelData applyCouponModelData;
  final String message;

  ApplyCouponModel.fromJsonMap(Map<String, dynamic> map)
      : status = map['status'],
        applyCouponModelData = ApplyCouponModelData.fromJsonMap(map['data']),
        message = map['message'];
}

class ApplyCouponModelData {
  final int id;
  ...
  ApplyCouponModelData.fromJsonMap(Map<String, dynamic> map)
      : id = map['id'],
